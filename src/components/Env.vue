...
<script>
  ...
  export default{
    data(){
      return {
        envlist:'',
        tempurl:require('../../static/images/temp.png'),
        humiurl:require('../../static/images/humi.png'),
        lighturl:require('../../static/images/light.png'),
        pm25url:require('../../static/images/pm2.5.png'),
        hchourl:require('../../static/images/hcho.png'),
        show:false,
        mychart:'',
        option:{
