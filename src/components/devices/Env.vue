	...
	export default {
		data() {
			return {
				...
				airList: '',
				plugbaselist: '',
				onurl: require('../../../static/images/aircon_on.png'),
				offurl: require('../../../static/images/aircon_off.png'),
				switchon: require('../../../static/images/airconditioner/on.png'),
				switchoff: require('../../../static/images/airconditioner/off.png'),
				up: require('../../../static/images/airconditioner/up.png'),
				down: require('../../../static/images/airconditioner/down.png'),
				pbon: require('../../../static/images/airconditioner/pb_on.png'),
				pboff: require('../../../static/images/airconditioner/pb_off.png'),
				airflag: false,
				did: '',
				airname: '',
				temp_now: '',
		...
		methods: {
			turnAirState(e) {
				...
				$.post('/run/envControl/airControl', {
					did: did,
					fun: 'loop',
					arg: value
				}, function(data) {
			...
			turnPlugState(e) {
				...
				$.post('/run/envControl/plugControl', {
					did: did,
					state: value
				}, function(data) {
			...
			init() {
				var that = this;
				$.post('/run/envControl/getAirList', {
				...
				$.post('/run/envControl/getPlugStates', {
					building_id: sessionStorage.buildID,
					room_id: this.room_id
				}, function(data) {
		...
		watch: {
			...
			did: function() {
				var that = this;
				$.post('/run/envControl/getAirState', {
					did: this.did
				}, function(data) {
					that.temp_now = data.airConditioner.temp;
					that.model_now = data.airConditioner.model;
