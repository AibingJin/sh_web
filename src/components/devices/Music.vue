...
/*		background-color: #8e8e8e;*/
	...
	.playerorder .order{
		...
		width: 20px;
		height: 16px;
		background:url(../../../static/images/video/m_order.png) no-repeat center;
	}
	.playerorder .single{
		position: absolute;
		left: 50px;
		width: 20px;
		height: 16px;
		background:url(../../../static/images/video/m_single.png) no-repeat center;
	}
	.playerorder .random{
		position: absolute;
		left: 50px;
		width: 20px;
		height: 16px;
		background:url(../../../static/images/video/m_random.png) no-repeat center;
	}
	.player{
		position: relative;
		top:10px;
	...
	.player .btn_prev{
		...
		width: 16px;
		height: 16px;
		background:url(../../../static/images/video/m_prev.png);
	}
	.player .btn_play{
		position: absolute;
		left: 150px;
		width: 16px;
		height: 16px;
		background:url(../../../static/images/video/m_start.png);
	}
	.player .btn_stop{
		position: absolute;
		left: 150px;
		width: 16px;
		height: 16px;
		background:url(../../../static/images/video/m_stop.png);
	}
	.player .btn_next{
		position: absolute;
		left: 200px;
		width: 16px;
		height: 16px;
		background:url(../../../static/images/video/m_next.png);
	}
	...
	.player_progress_dot {
	    ...
	    width: 16px;
	    height: 16px;
	    background:url(../../../static/images/video/m_dot.png) no-repeat center;
	    opacity: 1;
	    filter: none;
}
	.player_voice{
	...
	.player_turnvoice{
		...
		width: 16px;
		height: 16px;
		background:url(../../../static/images/video/m_voice.png) no-repeat center;
	}
	.player_mute{
		position: absolute;
		bottom:40px;
		...
		width: 16px;
		height: 16px;
		background:url(../../../static/images/video/m_mute.png) no-repeat center;
	}
</style>
