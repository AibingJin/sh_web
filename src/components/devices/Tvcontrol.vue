...
<style scoped>
	...
	.top .mute{
		...
		width: 16px;
		height: 16px;
		background:url('../../../static/images/video/mute.png') no-repeat;
	}
	.power{
		width: 100%;
	...
	.top .power .power_center{
		background:url('../../../static/images/video/off2.png') no-repeat center;
	}
	.bottom .power .power_center{
		background:url('../../../static/images/video/home.png') no-repeat center;
	}
...
/*		background-color: #f00;*/
	...
	.center .c_up{
		background:url("../../../static/images/video/up.png") no-repeat center;
	}
	.center .c_down{
		background:url("../../../static/images/video/down.png") no-repeat center;
	}
	.center .c_left{
		display: inline-block;
		background:url("../../../static/images/video/left.png") no-repeat center;
		vertical-align: middle;
	}
	.center .c_right{
		display: inline-block;
		background:url("../../../static/images/video/right.png") no-repeat center;
		vertical-align: middle;
	}
	.center .confrim{
		width: 100%;
	...
	.footer .yinliang .add{
		margin-bottom: 10px;
		background: url("../../../static/images/video/add.png");
	}
	.footer .yinliang .dec{
		margin-top: 10px;
		background: url("../../../static/images/video/dec.png");
	}
	.footer .pindao .up{
		margin-bottom: 10px;
		background: url("../../../static/images/video/up.png");
	}
	.footer .pindao .down{
		margin-top: 10px;
		background: url("../../../static/images/video/down.png");
	}
</style>
